  ...
  render() {
    return (
      <div class="ui basic segment">
        <h2 className="StepsHeader" style={{ margin: "20px" }}>
          And now, you might ask, how can Cosmo help you save the planet?
        </h2>
        <div className="StepsBox">
          <div class="ui container four column grid">
            <div class="column">
              ...
              <p>
                Read, read, read! <br></br>Read more. Get smart.
              </p>
            </div>
            <div class="column">
              <img
                src={Data}
                alt="Hand holding phone with diagram on screen."
                style={{ width: "250px" }}
              />

              <h3 className="StepsHeader">STEP TWO</h3>
              <p>
                Data, baby! <br></br>Look at the numbers.
              </p>
            </div>
            <div class="column">
              <img
              ...
              <p>
                Ready, action! <br></br>Get inspired. Do good.
              </p>
            </div>
            <div class="column">
              <img
                src={Save}
                alt="Two hands stretching towards planet earth."
                style={{ width: "250px" }}
              />

              <h3 className="StepsHeader">STEP FOUR</h3>
              <p>
                Save the planet! <br></br>No. Seriously. Do it.
              </p>
            </div>
          </div>
        </div>
