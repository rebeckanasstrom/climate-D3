        ...
        return (
            <div class="ui basic segment" style={{backgroundColor: "#fffdfd"}}>
                <div className="FossilArticleBox" style={{textAlign:"left", width:"60%", marginLeft:"29rem"}}>
                    ...
                    <div>
                        <h2 style={{marginBottom:"2.5em", marginLeft: "230px"}}>Don't worry - we got you! We asked our community what they do to live a more sustainable everyday life</h2>
                    </div>
                    <div class="ui grid">
                        <div class="four wide column">
                        ...
                        <div class="twelve wide column">
                            ...
                            <p style={{marginBottom:"2em", fontFamily: "Century Gothic"}}><strong>Check out the climate change movement by Greta Thunberg:</strong> <a style={{color: "rgb(84, 178, 204)"}} href="https://www.fridaysforfuture.org/" target="_blank"><strong>Fridays for Future</strong></a></p>
                        </div>
                        <div class="four wide column">
                        ...
                        <div class="twelve wide column">
                            ...
                            <p>I know that it's tempting to buy a new dress from that store, but have you ever considered to get your new dress from a second hand store instead? A lot of second hand stores have lovely and basically unworn pieces just waiting for a new home! ! Online stores like Asos.com and Ebay.com sell thrifted clothes, so if you can’t buy your items in thrift shop, you can go online and buy them instead. You could also host a clothing swap party,  where you trade your unwanted clothes in exchange for another person's unwanted items - it's a win, win!</p>
                            <p style={{marginBottom:"2em", fontFamily: "Century Gothic"}}><strong>Read our guide on how to thrift shop:</strong> <a style={{color: "rgb(84, 178, 204)"}} href="https://www.cosmopolitan.co.za/advice-buys/how-to-thrift-shop/" target="_blank"><strong>How to Thrift Shop</strong></a></p>
                        </div>
                        <div class="four wide column">
                        ...
                        <div class="twelve wide column">
                            ...
                            <p style={{marginBottom:"2em", fontFamily: "Century Gothic"}}><strong>You can find Ecosia’s search engine here:</strong> <a style={{color: "rgb(84, 178, 204)"}} href="https://www.ecosia.org/ " target="_blank"><strong>Ecosia.org</strong></a></p>
                        </div>
                ...
                <div className="FossilArticleBox" style={{textAlign:"left", width:"60%", marginLeft:"29rem"}}>
                    ...
                    <div class="ui grid">
                        ...
                        <div class="twelve wide column">
                            ...
                            <p style={{marginBottom:"2em", fontFamily: "Century Gothic"}}><strong>If you’re curious about DIY:ing your own products (healthy both for your family and your pockets) you should check out this website:</strong> <a style={{color: "rgb(84, 178, 204)"}} href="https://www.backwoodshome.com/clean-up-your-act/ " target="_blank"><strong>How to Clean Up Your Act</strong></a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="FossilArticleBox" style={{textAlign:"left", width:"60%", marginLeft:"29rem"}}>
                    ...
                    <div class="ui grid">
                        ...
                        <div class="twelve wide column">
                            ...
                            <p style={{marginBottom:"2em", fontFamily: "Century Gothic"}}><strong>Check out Grannsaker, an awesome app where sharing with your neighbours is made easier. Grannsaker is available both for iOs and Android:</strong> <a style={{color: "rgb(84, 178, 204)"}} href="https://grannsaker.se/" target="_blank"><strong>Grannsaker.se</strong></a></p>
                        </div>
                        <div class="four wide column">
