    ...
    return (
      <div>
        <h1 style={{ color: "#38A0BC", marginTop: "50px" }}>
          Don't be fooled by the beautiful colors, these fossil fuels are dirty!
        </h1>
        <br />
        <Popup
          trigger={
        ...
        >
          <div className="PopUpText">
            <p>
              <strong>Gas Fuel:</strong> fuels that are gas in their normal
              condition, like methane, propane and carbon monoxide.
            </p>
            <p>
              <strong>Liquid Fuel:</strong> a broad term to describe different
              liquid fuels, such as petroleum and oil.
            </p>
            <p>
            ...
            <p>
              ...
              processes and burning of materials and fuel is required, in turn
              releasing high amounts of carbon dioxide.
            </p>
            <p>
              <strong>Gas Flaring:</strong> the burning of gas and liquids in
              industrial processes, for example in petroleum refineries and
              chemical plants.
            </p>
            <br />
            <p>
        ...
        >
          <div className="PopUpText">
            <p>
              ...
              <br /> potential, in turn, describes how long a greenhouse gas is
              active in the atmosphere. Getting the right
              <br /> numbers means you multiply the tonnes of the gas with their
              respective global warming potentials,
              <br /> ending up with the final million metric tonne of carbon
              measurement.
            </p>
            <p>
              ...
              <br /> comparing them in million metric tonnes, we can determine
              their individual impact on climate change.
            </p>
            <p>
              <strong>So what's up with the diagram? Fossil fuels?</strong>
              <br />
              If you look at the diagram you’ll see a number of different
              categories. How do they relate
        ...
        <FossilLine chartData={this.state.fuelEmissionsChart} />
      </div>
    );
  }
}
