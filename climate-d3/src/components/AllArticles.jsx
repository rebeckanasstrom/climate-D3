        ...
        >
          ...
          <div>
            <h2 style={{ fontSize: "1.7rem", color: "#313030" }}>
              ...
              causes of climate change. But what exactly are they, and how are
              they messing up the future of our planet?{" "}
            </h2>
          </div>
            ...
            <div className="ColumnStyle">
              <div class="column">
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  energy. The efficiency/effectiveness of fossil fuels, however,
            ...
            <div className="ColumnStyle">
              <div class="column">
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  effects are clear but what are the reasons? It doesn't look
                  any better than we have ourselves to blame. Carbon dioxide
                  emission and other greenhouse gases like methane or nitrous
                  oxide are emitted directly into the atmosphere and there they
                  trap the heat. Too much of these gases are making our planet
                  warmer and leads to heatwaves, droughts and lack of water but
                  also natural disasters like coastal storms, flooding or
                  wildfires.{" "}
                </p>

                <p style={{ textAlign: "left" }}>
                  Because of the warm temperature, there is a greater risk of
                  wildfires now than ever before. Heatwaves are getting more and
                  more common in many places around the world and if we add
                  intense drought to that we have the perfect fuel for
                  ...
                  effect of the global warming and it is ruthless and shows no
                  mercy. Homes are destroyed, animals are killed, and the
                  vegetation is damaged for life.
                </p>

                <p style={{ textAlign: "left" }}>
                  If the global warming continues to rise, we ́ll see more
                  serious effects in the future. More heatwaves and drought lead
                  to a decreased harvest that will threaten the world's food
                  supply. The rapid rise in temperature changes ecosystems and
                  can lead to the loss of many species. Weather related natural
                  disasters will make certain places uninhabitable. We all know
                  that natural disasters, even today, force people to leave
                  their homes. But with a global temperature that increases by
                  two degrees, more people, animals and places will be affected.
                  Let’s make sure we stop before we reach two degrees!{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div>
            <h2 style={{ fontSize: "1.7rem" }}>
              ...
              melting, rapidly. The root of this phenomenon is our human
            ...
            <div className="ColumnStyle">
              <div class="column">
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  earth's temperatures. Raised temperatures in turn lead to
                ...
                <p style={{ textAlign: "left" }}>
                  If the glaciers continue to melt in a rapid way, the
                  consequences will affect the whole planet. As sea ice and
                  glaciers melt and oceans warm, ocean currents will continue to
                  disrupt weather patterns. Flooding will happen more frequently
                  and storms will increase, causing an insane amount of recovery
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  causes the bears to go into hibernation roughly 10 kilos
            ...
            <div className="ColumnStyle">
              <div class="column">
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  to differences in geography, gravity, temperature, ocean
                ...
                <p style={{ textAlign: "left" }}>
                  ...
                  there is a clear link between them and the rising sea level.
                  ...
                  must live with a constant fear that their home could be
