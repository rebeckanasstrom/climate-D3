        ...
        return (
            <div class="ui basic segment" style={{backgroundColor: "#fef6fa"}}>
                <div className="FossilArticleBox" style={{textAlign:"left", width:"80%", marginLeft:"12rem"}}>
                    ...
                    <div>
                        <h2 style={{fontSize:"1.7rem", color: "#313030"}}> Everyone's heard it by now: fossil fuels are one of the main causes of climate change. But what exactly are fossil fuels, and how are they messing up 
                    ...
                    <div className="ColumnStyle">
                        <div class="column"> 
                            ...
                            fossil fuels supply more than 80% of the world's total energy. The effectiveness of fossil fuels, however, 
                            ...
                            underneath the earth's crust. The three main fossil fuels include coal, petroleum and natural gas. When these are burnt, 
                ...
                <div className="FossilArticleBox" style={{textAlign:"left", width:"80%", marginLeft:"12rem"}}>
                    ...
                    <div className="ColumnStyle">
                        <div class="column">
                            ...
                            drought last year! The effects are clear but what are the reasons? If you wonder, we have ourselves to blame. 
                            Carbon dioxide emission and other greenhouse gases like methane or nitrous oxide are emitted directly into the 
                            atmosphere and there they trap the heat. Too much of these gases are making our planet warmer and leads to 
                            heatwaves, droughts and lack of water but also natural disasters like coastal storms, flooding and wildfires. </p>
                        
                            <p style={{textAlign:"left"}}>Because of the warm temperature, there is a greater risk of having wildfires 
                            now than ever before. Heatwaves are getting more and more common in many places around the world and 
                            if we add intense droughts to this, we have the perfect fuel for wildfires. The rising temperature has 
                            lengthened the wildfire season and made the soil drier and more flammable which help the fire to spread 
                            more easily. Wildfires are one serious effect of the global warming. They are ruthless and show no mercy. 
                            Homes are destroyed, animals are killed, and the vegetation is damaged for life.</p> 
                             
                       
                        
                        <p style={{textAlign:"left"}}>If the global warming continues to rise, we'll see more serious effects in the 
                        future. More heatwaves and droughts will lead to decreased harvests, in turn threatening the world's food supply. 
        ...
        return (
            <div class="ui basic segment" style={{backgroundColor: "#fef6fa"}}>
                <div className="FossilArticleBox" style={{textAlign:"left", width:"80%", marginLeft:"12rem"}}>
                    ...
                    <div>
                    <h2 style={{fontSize:"1.7rem"}}>Since the early 1900s, many of the world's glaciers have been melting, rapidly. The root of this phenomenon are our human activities. 
                    ...
                    <div class="ui padded one column grid">
                        ...
                        <div class="column">
                            ...
                            machines, carbon dioxide and other greenhouse gas emissions have raised the earth's temperature. Raised temperature in turn leads to melting 
                            ...
                            cause it to rapidly melt and retreat up on land.</p>

                            <p style={{textAlign:"left"}}>If the glaciers continue to melt rapidly, the consequences will affect the whole planet. As sea ice and 
                            glaciers melt and oceans get's warmer, ocean currents will continue to disrupt weather patterns. Flooding will happen more frequently and storms will 
                            ...
                            affect where and when fish spawn.</p>
                             ...
                             spring, it causes the bears to go into hibernation roughly when 10 kilos lighter and in poorer condition than before. Unhealthy bears can lead to 
                ...
                <div className="FossilArticleBox" style={{textAlign:"left", width:"80%", marginLeft:"12rem"}}>
                    ...
                    <div className="ColumnStyle">
                        <div class="column">
                            ...
                            since it varies from place to place and to differences in geography, gravity, temperature, ocean currents and tides. The best 
                            ...
                            of the rising and falling tide.</p>
                            ...
                            added into the oceans and the sea level is rising. </p>
                             ...
                             common and there's a clear link between them and the rising sea level. Even entire islands can disappear if 
                             climate change continues to affect the sea level. Islands in the Pacific Ocean are already suffering from the 
                             consequences and many islanders must live with a constant fear that their homes could be swallowed up by the sea. 
